 ...
 *
 * If the request method is safe (as defined by RFC 2616, Section 9.1.1, e.g. either "GET" nor "HEAD"),
 ...
 * For each request header named "Origin", let the /initiating origin list/ be the list of origins represented:
 * If there exists a origin in the /initiating origin list/ is not a member of the /origin white list/ for this server,
 * return "MUST NOT modify state" and abort these steps.
